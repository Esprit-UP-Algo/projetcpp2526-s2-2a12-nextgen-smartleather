...
public:
    ...
    QFrame *frame_ai;
    QVBoxLayout *vbox_ai;
    QLabel *label_ai_intro;
    QTextBrowser *tb_ai_log;
    QHBoxLayout *hbox_ai_input;
    QLineEdit *le_ai_input;
...
"   "));
        ...
        frame_ai = new QFrame(page_ai);
        frame_ai->setObjectName("frame_ai");
        vbox_ai = new QVBoxLayout(frame_ai);
        vbox_ai->setObjectName("vbox_ai");
        label_ai_intro = new QLabel(frame_ai);
        label_ai_intro->setObjectName("label_ai_intro");
        label_ai_intro->setWordWrap(true);

        vbox_ai->addWidget(label_ai_intro);

        tb_ai_log = new QTextBrowser(frame_ai);
        tb_ai_log->setObjectName("tb_ai_log");
        tb_ai_log->setMinimumHeight(240);

        vbox_ai->addWidget(tb_ai_log);

        hbox_ai_input = new QHBoxLayout();
        hbox_ai_input->setObjectName("hbox_ai_input");
        le_ai_input = new QLineEdit(frame_ai);
        le_ai_input->setObjectName("le_ai_input");
        le_ai_input->setMinimumHeight(44);

        hbox_ai_input->addWidget(le_ai_input);

        btn_ai_send = new QPushButton(frame_ai);
        btn_ai_send->setObjectName("btn_ai_send");
        btn_ai_send->setMinimumSize(QSize(120, 44));

        hbox_ai_input->addWidget(btn_ai_send);


        vbox_ai->addLayout(hbox_ai_input);


        verticalLayout_ai->addWidget(frame_ai);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        btn_tab_list->setText(QCoreApplication::translate("MainWindow", "Liste des commandes", nullptr));
        btn_tab_stats->setText(QCoreApplication::translate("MainWindow", "Stats des commandes", nullptr));
        btn_tab_email_auto->setText(QCoreApplication::translate("MainWindow", "Historique des emails", nullptr));
...
"QListWidget::item:selected { background-color: #C68E65; color: white; }", nullptr));
        ...
        frame_ai->setStyleSheet(QCoreApplication::translate("MainWindow", "background: white; border-radius: 12px; border: 1px solid #e8d7c7; padding: 16px;", nullptr));
        label_ai_intro->setStyleSheet(QCoreApplication::translate("MainWindow", "font-size: 14px; font-weight: 600; color: #5a3b2a;", nullptr));
        label_ai_intro->setText(QCoreApplication::translate("MainWindow", "Posez vos questions sur les mati\303\250res et les stocks. (Prototype avec r\303\251ponses fixes)", nullptr));
        tb_ai_log->setStyleSheet(QCoreApplication::translate("MainWindow", "background:#FFFCFA; border:1px solid #DDC6B0; border-radius: 10px; padding: 10px; color:#3b2a20;", nullptr));
        le_ai_input->setPlaceholderText(QCoreApplication::translate("MainWindow", "Ex: Donne-moi l'\303\251tat du stock cuir", nullptr));
        le_ai_input->setStyleSheet(QCoreApplication::translate("MainWindow", "background-color: white; border: 1px solid #C68E65; border-radius: 10px; padding: 10px; font-weight: 600; color:#3b2a20;", nullptr));
        btn_ai_send->setStyleSheet(QCoreApplication::translate("MainWindow", "QPushButton{background:#8B4513;color:white;padding:10px 18px;border-radius:10px;font-weight:700;} QPushButton:hover{background:#a05a22;} QPushButton:pressed{background:#723a0f;}", nullptr));
        btn_ai_send->setText(QCoreApplication::translate("MainWindow", "Envoyer", nullptr));
    } // retranslateUi
