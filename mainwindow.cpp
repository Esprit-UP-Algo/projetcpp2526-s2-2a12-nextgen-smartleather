    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(ui->gestion_fournisseurs, &QPushButton::clicked, this, [=]() {
        ...
        ui->stackedWidget_orders->setCurrentWidget(ui->pageAjouter);
    });
    ...
    connect(ui->btnAjouter_2, &QPushButton::clicked, this, [=]() {
        ui->stackedWidget_3->setCurrentWidget(ui->pageAjouter);
    });

    connect(ui->btnModifier_2, &QPushButton::clicked, this, [=]() {
        ui->stackedWidget_3->setCurrentWidget(ui->pageModifier);
    });

    connect(ui->btnSupprimer_2, &QPushButton::clicked, this, [=]() {
        ui->stackedWidget_3->setCurrentWidget(ui->pageSupprimer);
    });
